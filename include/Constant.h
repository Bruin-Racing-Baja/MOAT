...
struct Constant{
    ...
    int int_size = 10;
    int float_size = 4;
    int *ints[10] = {&mode, &home_on_startup, &wait_serial_startup, &log_level, &save_threshold, &k_cooling_rpm, &k_temp_threshold, &k_cooling_cycle_period, &k_desired_rpm, &k_actuator_cycle_period};
